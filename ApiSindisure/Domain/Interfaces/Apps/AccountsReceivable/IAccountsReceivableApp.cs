...
namespace ApiSindisure.Domain.Interfaces.Apps.AccountsReceivable
{
    public interface IAccountsReceivableApp
    {
        ...
        Task<List<AccountsReceivableViewModel.Response>> CreateAccountsReceivableBuildingsAsync(List<AccountsReceivableViewModel.CreateRequest> request, CancellationToken cancellationToken);
