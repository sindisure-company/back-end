...
namespace ApiSindisure.Domain.Interfaces.Apps.CompaniesRecurring
{
    public interface ICompaniesRecurringApp
    {
        ...
        Task<CompaniesRecurringViewModel.Response> GetUniqueCompaniesRecurringAsync(CompaniesRecurringViewModel.GetRequest request, CancellationToken cancellationToken);
        Task<List<CompaniesRecurringViewModel.Response>> GetCompaniesRecurringIsActiveAsync(CompaniesRecurringViewModel.GetRequest request, CancellationToken cancellationToken);
